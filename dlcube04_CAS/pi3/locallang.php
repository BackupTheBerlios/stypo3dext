...
$LOCAL_LANG = Array (
	"default" => Array (
		...
		"desc_formulaire"=>"Veuillez saisir un identifiant ainsi qu'un mot de passe pour créer votre compte sur le système d'authentification des Haras Nationaux.\nPour l'identifiant, ne sont autorisés que les lettres sans accents, les chiffres, le point et les tirets.",
		"login" =>"identifiant",
		"passwd"=>"mot de passe",
		"passwd2"=>"mot de passe pour vérification",
