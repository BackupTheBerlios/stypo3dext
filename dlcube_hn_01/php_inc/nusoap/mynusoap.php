...
/*
$Id: mynusoap.php,v 1.1 2007/01/21 18:21:21 vmaury Exp $
...
* @version  $Id: mynusoap.php,v 1.1 2007/01/21 18:21:21 vmaury Exp $
* @access   public
*/
class nusoap_base {
	/**
...
if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/dlcube_hn_01/php_inc/nusoap/nusoap.php"])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/dlcube_hn_01/php_inc/nusoap/nusoap.php"]);
}
?>
