...
***************************************************************/
/**
 * Plugin 'Newsletters - Regions News' for the 'dlcube_newsletters' extension.
 *
...
class tx_dlcubenewsletters_pi2 extends tslib_pibase {
	var $prefixId = 'tx_dlcubenewsletters_pi2';		// Same as class name
	var $scriptRelPath = 'pi2/class.tx_dlcubenewsletters_pi2.php';	// Path to this script relative to the extension dir.
	...
	function listView($content,$conf)	{
		...
		if ($this->piVars['showUid'])	{	// If a single element should be displayed:
			$this->internal['currentTable'] = 'tx_dlcubenewsletters_region_ids';
			$this->internal['currentRow'] = $this->pi_getRecord('tx_dlcubenewsletters_region_ids',$this->piVars['showUid']);
			...
			$res = $this->pi_exec_query('tx_dlcubenewsletters_region_ids',1);
			list($this->internal['res_count']) = $GLOBALS['TYPO3_DB']->sql_fetch_row($res);
	
				// Make listing query, pass query to SQL database:
			$res = $this->pi_exec_query('tx_dlcubenewsletters_region_ids');
			$this->internal['currentTable'] = 'tx_dlcubenewsletters_region_ids';
	...
	function makeListItem()	{
		...
		// est-ce qu'il y a bien des valeurs ?
 		if($this->getFieldContent('news_uid')) {
			...
			$out .= '<img src="fileadmin/templates/newsletters/images/actu_region.gif">';
			...
			{
				$out .= '  <li><a href="index.php?id='.$row['pid'].'&vm19news_dirlink_uid='.$row['uid'].'#Anc'.$row['uid'].'">'.$row['title'].'</a></li>';
			}
			$out .= '</ul>';
		}
		else
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dlcube_newsletters/pi2/class.tx_dlcubenewsletters_pi2.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dlcube_newsletters/pi2/class.tx_dlcubenewsletters_pi2.php']);
}
