<?php
/**
 * Language labels for plugin "tx_vm19hnlinks_pi1"
 *
...
$LOCAL_LANG = Array (
	"default" => Array (
		"listFieldHeader_url_url" => "URL",	
		"listFieldHeader_url_title" => "title",	
		"listFieldHeader_url_desc" => "Description",	
		"listFieldHeader_url_kwords" => "Key words",	
		"listFieldHeader_url_state" => "State",	
		"listFieldHeader_url_mailwb" => "Webmaster mail",	
		"listFieldHeader_url_lang" => "Language(s)",	
		"listFieldHeader_url_othercateg" => "Other Category",	
		"listFieldHeader_url_datev" => "Last Validation date",	
		"list_mode_1" => "Mode 1",	
		"list_mode_2" => "Mode 2",	
		"list_mode_3" => "Mode 3",	
		"back" => "Back",	
