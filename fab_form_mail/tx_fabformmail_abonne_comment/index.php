...
***************************************************************/
/** 
 * fab_form_mail module tx_fabformmail_abonne_commentwiz0
 *
...
class tx_fabformmail_tx_fabformmail_abonne_commentwiz extends t3lib_SCbase {
	/**
...
if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/fab_form_mail/tx_fabformmail_abonne_comment/index.php"])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/fab_form_mail/tx_fabformmail_abonne_comment/index.php"]);
}
...
// Make instance:
$SOBE = t3lib_div::makeInstance("tx_fabformmail_tx_fabformmail_abonne_commentwiz");
$SOBE->init();
